Task: eligibility judge (first path), part 1.
Folder: ~/Projects/and-again-content/new_exercises_20260923/r2/elig/
1. Read RULE.md in that folder — it is the full standard.
2. Read judge_input_1.json (a JSON array of {id, sentences}).
...
4. Write judge_output_1.json: a JSON array, same order and same length as the input, each {"id", "full", "sentence"}.
