Task: independent eligibility verifier, part 3.
...
2. Read verify_input_3.json (a JSON array of {id, sentences}).
...
4. Write verify_output_3.json: a JSON array, same order and same length as the input, each {"id", "full", "sentence"}.
