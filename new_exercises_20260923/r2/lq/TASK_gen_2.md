Task: write listening questions, part 2.
...
2. Read gen_input_2.json (JSON array of videos).
...
4. Write gen_output_2.json: JSON array, same order and length as the input, each
