Task: independent verifier for listening questions, part 1.
...
2. Read ver_input_1.json (JSON array; each item is ONE proposed question with its video context and a "key").
...
4. Write ver_output_1.json: JSON array, same order and length, each {"key","verdict","reason","drop_variants"}.
