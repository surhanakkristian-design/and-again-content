Task: write listening questions, part 1.
...
2. Read gen_input_1.json (JSON array of videos).
...
4. Write gen_output_1.json: JSON array, same order and length as the input, each
