Task: write listening questions, part 6.
...
2. Read gen_input_6.json (JSON array of videos).
...
4. Write gen_output_6.json: JSON array, same order and length as the input, each
