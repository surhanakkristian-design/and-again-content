Task: write listening questions, part 5.
...
2. Read gen_input_5.json (JSON array of videos).
...
4. Write gen_output_5.json: JSON array, same order and length as the input, each
