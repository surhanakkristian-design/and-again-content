Task: write listening questions, part 4.
...
2. Read gen_input_4.json (JSON array of videos).
...
4. Write gen_output_4.json: JSON array, same order and length as the input, each
