# Part 4 — explicit-subject rewrite (arm B) for <LANG>

You are a native-level editor of <LANG>. Each input line is one exercise row:
```
...
subject pronoun (<PRONOUNS>) agreeing with that verb, at the natural position for <LANG>. If the main clause already has
