# Part 4 — explicit-subject rewrite (arm B) for Ukrainian

You are a native-level editor of Ukrainian. Each input line is one exercise row:
```
...
subject pronoun (я/ти/він/вона/воно/ми/ви/вони) agreeing with that verb, at the natural position for Ukrainian. If the main clause already has
