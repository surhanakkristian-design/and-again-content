# Part 4 — explicit-subject rewrite (arm B) for Turkish

You are a native-level editor of Turkish. Each input line is one exercise row:
```
...
subject pronoun (ben/sen/o/biz/siz/onlar) agreeing with that verb, at the natural position for Turkish. If the main clause already has
