# Part 4 — explicit-subject rewrite (arm B) for Spanish

You are a native-level editor of Spanish. Each input line is one exercise row:
```
...
subject pronoun (yo/tú/él/ella/usted/nosotros/nosotras/vosotros/vosotras/ellos/ellas/ustedes) agreeing with that verb, at the natural position for Spanish. If the main clause already has
