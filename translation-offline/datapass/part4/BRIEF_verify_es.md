# Part 4 — independent second-pass check of explicit-subject rewrites (Spanish)
...
Spanish editor. Write ONE output file, touch nothing else, run no scripts.
...
4. the new sentence is grammatical, natural Spanish.
