#!/usr/bin/env python3
"""Phase 1S Task C — rule AG v2 (copy of Task A's agent_drop.py; the ONLY change is a
complete standard list of English irregular past participles, plus one extra pre-flight row)

rule AG: the DROPPED AGENT is a meaning omission (deterministic, 0 model calls).
...
IRREG_PP = {
    # complete standard list of English irregular past participles (AG v2; v1 was partial and
    # missed e.g. 'lent' -> false accept on W:170088:w2). Written from general knowledge.
    'arisen', 'awoken', 'been', 'beaten', 'become', 'begun', 'bent', 'bet', 'bound', 'bitten',
    'bled', 'blown', 'broken', 'bred', 'brought', 'broadcast', 'built', 'burnt', 'burned',
    'burst', 'bought', 'cast', 'caught', 'chosen', 'clung', 'come', 'cost', 'crept', 'cut',
    'dealt', 'dug', 'done', 'drawn', 'dreamt', 'dreamed', 'drunk', 'driven', 'dwelt', 'eaten',
    'fallen', 'fed', 'felt', 'fought', 'found', 'fled', 'flung', 'flown', 'forbidden',
    'forecast', 'forgotten', 'forgiven', 'frozen', 'got', 'gotten', 'given', 'gone', 'ground',
    'grown', 'hung', 'had', 'heard', 'hidden', 'hit', 'held', 'hurt', 'kept', 'knelt', 'known',
    'laid', 'led', 'leant', 'leaned', 'leapt', 'leaped', 'learnt', 'learned', 'left', 'lent',
    'let', 'lain', 'lit', 'lost', 'made', 'meant', 'met', 'mistaken', 'mown', 'overcome',
    'overtaken', 'paid', 'proven', 'put', 'quit', 'read', 'rebuilt', 'ridden', 'rung', 'risen',
    'run', 'sawn', 'said', 'seen', 'sought', 'sold', 'sent', 'set', 'sewn', 'shaken', 'shed',
    'shone', 'shot', 'shown', 'shrunk', 'shut', 'sung', 'sunk', 'sat', 'slept', 'slid', 'slit',
    'smelt', 'sown', 'spoken', 'sped', 'spelt', 'spelled', 'spent', 'spilt', 'spun', 'spat',
    'split', 'spoilt', 'spread', 'sprung', 'stood', 'stolen', 'stuck', 'stung', 'stunk',
    'struck', 'sworn', 'swept', 'swollen', 'swum', 'swung', 'taken', 'taught', 'torn', 'told',
    'thought', 'thrown', 'thrust', 'trodden', 'undergone', 'understood', 'undertaken', 'upset',
    'woken', 'worn', 'wept', 'won', 'wound', 'withdrawn', 'written',
    # regular forms v1 listed explicitly (kept; they are also caught by the -ed rule)
    'repaired', 'delivered'}
...
SYN = [
    ...
    ('lent: v1 gap (will be lent)', 'Knižnica požičia tieto učebnice na jeden semester.',
     {'voice_sk': 'active_agent', 'agent_nom': True}, {'nom_agent': True, 'agent': 'knižnica'},
     'These textbooks will be lent for one semester only.',
     'The library will lend these textbooks for one semester only.', True, True),
]
