#!/usr/bin/env python3
"""Phase 2J copy of the Phase 2I TRANSLATION-ONLY stack (+ A2 F4v2 fix, P2J_F4FIX). Phase 2I - TRANSLATION-ONLY stack = the frozen 1W stack (stack_frozen.py engine, runner_1u in place) with the
...
E.STATE['stack'] = 'tonly'
# Phase 2J A2: F4v2 reader fix (f4fix.py) applied right after the chain is imported. P2J_F4FIX=0 = the 2I stack.
