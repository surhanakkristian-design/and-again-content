...
TOFF = os.path.dirname(os.path.dirname(P1U))                 # translation-offline (1W: P1U = phase1w/a4; import-path fix, pre-run)
P1T_RUN = os.path.join(TOFF, 'phase1t', 'run')
P1P = os.path.join(TOFF, 'phase1p')
P1S = os.path.join(TOFF, 'phase1s')
TASKA = os.path.join(TOFF, 'phase1u', 'taskA')   # 1W: AG v4 home
