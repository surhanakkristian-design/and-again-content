#!/usr/bin/env python3
"""Phase 2I stage 4: judge labels, duplicate-control agreement, judge vs writer intent, runner item file.
...
# runner item file
ann = {}
for r in jl(os.path.join(P2I, 'upload', 'annotations_sk_fixed.jsonl')): ann[r['n']] = r
items = []
for r in labels:
...
ip = os.path.join(P2I, 'set', 'items.jsonl')
