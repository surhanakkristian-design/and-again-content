...
TOFF = '/Users/kristiansurhanak/Projects/and-again-content/translation-offline'   # probe: pinned to the real translation-offline root
P1U = os.path.join(TOFF, 'phase1u')
P1T_RUN = os.path.join(TOFF, 'phase1t', 'run')
P1P = os.path.join(TOFF, 'phase1p')
P1S = os.path.join(TOFF, 'phase1s')
TASKA = os.path.join(TOFF, 'phase1u', 'taskA')   # probe: AG v4 home
...
LEDGER_DEV = os.path.join(PROBE_DIR, 'ledger_2g_a.jsonl')
MIRROR_STATE = os.path.join(HERE, 'ledger_mirror_state.json')
