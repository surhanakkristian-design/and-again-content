...
**Types 76 and 77 ("Random", A and B, focus category Vocabulary) are UNRULED.** Kristian was
...
UNRULED_TYPES = frozenset({76, 77})             # "Random" A/B — Vocabulary focus, no ruling
...
def scope_for(exercise_type, profile=DEFAULT_PROFILE):
    ...
    if t in UNRULED_TYPES:
        raise UnruledTypeError(
            f"exercise type {t} (\"Random\", Vocabulary) has no ruled language scope — "
