-- ============================================================================
-- 5b pass P/ua: French spacing in ua full_sentence (population: ua rows with
-- full_sentence not null, intro_text carrying a blank, exercise_type <> 69, and a space
-- before , . ; : ! ? in full_sentence). Expected 13 rows, 0 of them chunked.
...
where el.full_sentence is not null and el.intro_text like '%...%' and e.exercise_type_id <> 69
  and el.language_code = 'ua' and el.full_sentence ~ ' [,.;:!?]';
