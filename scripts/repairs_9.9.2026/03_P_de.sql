-- ============================================================================
-- 5b pass P/de: French spacing in de full_sentence (population: de rows with
-- full_sentence not null, intro_text carrying a blank, exercise_type <> 69, and a space
-- before , . ; : ! ? in full_sentence). Expected 11 rows, 11 of them chunked.
...
where el.full_sentence is not null and el.intro_text like '%...%' and e.exercise_type_id <> 69
  and el.language_code = 'de' and el.full_sentence ~ ' [,.;:!?]';
