-- ============================================================================
-- 5b pass P/en: French spacing in en full_sentence (population: en rows with
...
where el.full_sentence is not null and el.intro_text like '%...%' and e.exercise_type_id <> 69
  and el.language_code = 'en' and el.full_sentence ~ ' [,.;:!?]';
...
from ok
where el.id = ok.id and el.language_code = 'en'
