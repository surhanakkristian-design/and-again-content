-- ============================================================================
-- 5b pass P/tr: French spacing in tr full_sentence (population: tr rows with
-- full_sentence not null, intro_text carrying a blank, exercise_type <> 69, and a space
-- before , . ; : ! ? in full_sentence). Expected 45 rows, 0 of them chunked.
...
where el.full_sentence is not null and el.intro_text like '%...%' and e.exercise_type_id <> 69
  and el.language_code = 'tr' and el.full_sentence ~ ' [,.;:!?]';
